...
<body>
    <div id="wrapper">
        ...
        <form method="POST">
            ...
            <input type="password" name="password" class="field transition" placeholder="password">
            <input type="password" name="confirm" class="field transition" placeholder="confirm password">
